...
class Index extends ViewPU {
    ...
    initialRender() {
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create('⏳ 倒计时器');
            Text.debugLine("entry/src/main/ets/pages/Index.ets(80:7)", "entry");
            Text.fontSize(28);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Text.debugLine("entry/src/main/ets/pages/Index.ets(85:7)", "entry");
            Text.fontSize(48);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Row.create({ space: 10 });
            Row.debugLine("entry/src/main/ets/pages/Index.ets(90:7)", "entry");
            Row.margin({ top: 30 });
        }, Row);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            TextInput.create({ placeholder: '时', text: this.hours });
            TextInput.debugLine("entry/src/main/ets/pages/Index.ets(91:9)", "entry");
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create(':');
            Text.debugLine("entry/src/main/ets/pages/Index.ets(96:9)", "entry");
            Text.fontSize(24);
        }, Text);
        Text.pop();
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            TextInput.create({ placeholder: '分', text: this.minutes });
            TextInput.debugLine("entry/src/main/ets/pages/Index.ets(98:9)", "entry");
            TextInput.type(InputType.Number);
            TextInput.width(80);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create(':');
            Text.debugLine("entry/src/main/ets/pages/Index.ets(103:9)", "entry");
            Text.fontSize(24);
        }, Text);
        Text.pop();
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            TextInput.create({ placeholder: '秒', text: this.seconds });
            TextInput.debugLine("entry/src/main/ets/pages/Index.ets(105:9)", "entry");
            TextInput.type(InputType.Number);
            TextInput.width(80);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Row.create({ space: 20 });
            Row.debugLine("entry/src/main/ets/pages/Index.ets(112:7)", "entry");
            Row.margin({ top: 30 });
        }, Row);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Button.debugLine("entry/src/main/ets/pages/Index.ets(120:9)", "entry");
